	...
	public class Startup {
		public Startup(IHostingEnvironment env) {
			var builder = new ConfigurationBuilder()
				...
				.AddCustomizedJsonFile(Modules, env, "/var/webos/TEST/");
		...
		public void Configure(IApplicationBuilder app, IHostingEnvironment env, ILoggerFactory loggerFactory, IApplicationLifetime lifetime) {
			...
			TEST.BLL.SqlHelper.Initialization(app.ApplicationServices.GetService<IDistributedCache>(), Configuration.GetSection("TEST_BLL_ITEM_CACHE"),
				Configuration["ConnectionStrings:TEST_mssql"], /* 此参数可以配置【从数据库】 */ null, loggerFactory.CreateLogger("TEST_DAL_sqlhelper"));

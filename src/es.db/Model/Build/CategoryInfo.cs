...
namespace es.Model {
	...
	public partial class CategoryInfo {
		...
		public CategoryInfo AddCategory(int? Id, string Name) => AddCategory(new CategoryInfo {
			Id = Id, 
			Name = Name});
		...
		public GoodsInfo AddGoods(Goods_tagInfo Goods_tag, string Content, string Imgs, int? Stock, string Title) => AddGoods(Goods_tag.Goods_id, Content, Imgs, Stock, Title);
		public GoodsInfo AddGoods(int? Id, string Content, string Imgs, int? Stock, string Title) => AddGoods(new GoodsInfo {
			Id = Id, 
			Content = Content, 
			Imgs = Imgs, 
			Stock = Stock, 
		...
		async public Task<CategoryInfo> AddCategoryAsync(int? Id, string Name) => await AddCategoryAsync(new CategoryInfo {
			Id = Id, 
			Name = Name});
		...
		async public Task<GoodsInfo> AddGoodsAsync(Goods_tagInfo Goods_tag, string Content, string Imgs, int? Stock, string Title) => await AddGoodsAsync(Goods_tag.Goods_id, Content, Imgs, Stock, Title);
		async public Task<GoodsInfo> AddGoodsAsync(int? Id, string Content, string Imgs, int? Stock, string Title) => await AddGoodsAsync(new GoodsInfo {
			Id = Id, 
			Content = Content, 
			Imgs = Imgs, 
			Stock = Stock, 

...
namespace es.BLL {
	...
	public partial class Goods_tag {
		...
		public static es.DAL.Goods_tag.SqlUpdateBuild UpdateDiy(int Goods_id) => new es.DAL.Goods_tag.SqlUpdateBuild(new List<Goods_tagInfo> { new Goods_tagInfo { Goods_id = Goods_id } }, false);
		...
		internal static void RemoveCache(IEnumerable<Goods_tagInfo> items) {
			...
			foreach (var item in items) {
				keys[keysIdx++] = string.Concat("es_BLL:Goods_tag:", item.Goods_id);
			}
		...
		public static Goods_tagInfo GetItem(int Goods_id) => SqlHelper.CacheShell(string.Concat("es_BLL:Goods_tag:", Goods_id), itemCacheTimeout, () => Select.WhereGoods_id(Goods_id).ToOne());
		...
		async public static Task<Goods_tagInfo> GetItemAsync(int Goods_id) => await SqlHelper.CacheShellAsync(string.Concat("es_BLL:Goods_tag:", Goods_id), itemCacheTimeout, () => Select.WhereGoods_id(Goods_id).ToOneAsync());

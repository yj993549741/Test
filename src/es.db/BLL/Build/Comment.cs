...
namespace es.BLL {
	...
	public partial class Comment {
		...
		/// </summary>
		[Obsolete]
		public static CommentInfo Insert(int? Id, int? Goods_id, string Content, string Nickname) {
		...
		/// </summary>
		[Obsolete]
		public static Task<CommentInfo> InsertAsync(int? Id, int? Goods_id, string Content, string Nickname) {

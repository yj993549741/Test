...
public static partial class TESTExtensionMethods {
	...
	public static TEST.DAL.Category.SqlUpdateBuild UpdateDiy(this List<CategoryInfo> items) => TEST.BLL.Category.UpdateDiy(items);
	...
	public static TEST.DAL.Comment.SqlUpdateBuild UpdateDiy(this List<CommentInfo> items) => TEST.BLL.Comment.UpdateDiy(items);
	...
	public static TEST.DAL.Goods.SqlUpdateBuild UpdateDiy(this List<GoodsInfo> items) => TEST.BLL.Goods.UpdateDiy(items);
	...
	public static TEST.DAL.Goods_tag.SqlUpdateBuild UpdateDiy(this List<Goods_tagInfo> items) => TEST.BLL.Goods_tag.UpdateDiy(items);
	...
	public static TEST.DAL.Tag.SqlUpdateBuild UpdateDiy(this List<TagInfo> items) => TEST.BLL.Tag.UpdateDiy(items);

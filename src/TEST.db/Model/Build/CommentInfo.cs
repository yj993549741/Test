...
namespace TEST.Model {
	...
	public partial class CommentInfo {
		...
		public GoodsInfo Obj_goods {
			get {
				if (_obj_goods == null && _Goods_id != null) _obj_goods = TEST.BLL.Goods.GetItem(_Goods_id.Value);
				return _obj_goods;
			}
		...
		public TEST.DAL.Comment.SqlUpdateBuild UpdateDiy => _Id == null ? null : BLL.Comment.UpdateDiy(new List<CommentInfo> { this });

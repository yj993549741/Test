...
namespace TEST.Model {
	...
	public partial class CategoryInfo {
		...
		public CategoryInfo Obj_category {
			get {
				if (_obj_category == null && _Parent_id != null) _obj_category = TEST.BLL.Category.GetItem(_Parent_id.Value);
		...
		public TEST.DAL.Category.SqlUpdateBuild UpdateDiy => _Id == null ? null : BLL.Category.UpdateDiy(new List<CategoryInfo> { this });

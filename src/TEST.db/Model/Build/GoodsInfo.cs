...
namespace TEST.Model {
	...
	public partial class GoodsInfo {
		...
		public Goods_tagInfo Obj_goods_tag {
			get {
				if (_obj_goods_tag == null && _Id != null) _obj_goods_tag = TEST.BLL.Goods_tag.GetItem(_Id.Value);
		...
		public CategoryInfo Obj_category {
			get {
				if (_obj_category == null && _Category_id != null) _obj_category = TEST.BLL.Category.GetItem(_Category_id.Value);
		...
		public TEST.DAL.Goods.SqlUpdateBuild UpdateDiy => _Id == null ? null : BLL.Goods.UpdateDiy(new List<GoodsInfo> { this });

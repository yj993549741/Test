...
namespace TEST.BLL {
	...
	public partial class Goods {
		...
		internal static readonly TEST.DAL.Goods dal = new TEST.DAL.Goods();
		...
		public static TEST.DAL.Goods.SqlUpdateBuild UpdateDiy(int Id) => new TEST.DAL.Goods.SqlUpdateBuild(new List<GoodsInfo> { new GoodsInfo { Id = Id } }, false);
		public static TEST.DAL.Goods.SqlUpdateBuild UpdateDiy(List<GoodsInfo> dataSource) => new TEST.DAL.Goods.SqlUpdateBuild(dataSource, true);
		public static TEST.DAL.Goods.SqlUpdateBuild UpdateDiyDangerous => new TEST.DAL.Goods.SqlUpdateBuild();
		...
		internal static void RemoveCache(IEnumerable<GoodsInfo> items) {
			...
			foreach (var item in items) {
				keys[keysIdx++] = string.Concat("TEST_BLL:Goods:", item.Id);
			}
		...
		public static GoodsInfo GetItem(int Id) => SqlHelper.CacheShell(string.Concat("TEST_BLL:Goods:", Id), itemCacheTimeout, () => Select.WhereId(Id).ToOne());
		...
		async public static Task<GoodsInfo> GetItemAsync(int Id) => await SqlHelper.CacheShellAsync(string.Concat("TEST_BLL:Goods:", Id), itemCacheTimeout, () => Select.WhereId(Id).ToOneAsync());

...
namespace TEST.BLL {
	...
	public partial class Comment {
		...
		internal static readonly TEST.DAL.Comment dal = new TEST.DAL.Comment();
		...
		public static TEST.DAL.Comment.SqlUpdateBuild UpdateDiy(int Id) => new TEST.DAL.Comment.SqlUpdateBuild(new List<CommentInfo> { new CommentInfo { Id = Id } }, false);
		public static TEST.DAL.Comment.SqlUpdateBuild UpdateDiy(List<CommentInfo> dataSource) => new TEST.DAL.Comment.SqlUpdateBuild(dataSource, true);
		public static TEST.DAL.Comment.SqlUpdateBuild UpdateDiyDangerous => new TEST.DAL.Comment.SqlUpdateBuild();
		...
		internal static void RemoveCache(IEnumerable<CommentInfo> items) {
			...
			foreach (var item in items) {
				keys[keysIdx++] = string.Concat("TEST_BLL:Comment:", item.Id);
			}
		...
		public static CommentInfo GetItem(int Id) => SqlHelper.CacheShell(string.Concat("TEST_BLL:Comment:", Id), itemCacheTimeout, () => Select.WhereId(Id).ToOne());
		...
		async public static Task<CommentInfo> GetItemAsync(int Id) => await SqlHelper.CacheShellAsync(string.Concat("TEST_BLL:Comment:", Id), itemCacheTimeout, () => Select.WhereId(Id).ToOneAsync());
